[![Build Status](https://dev.azure.com/sandbox-david/DevopsLeanring/_apis/build/status%2FCubeMan001.python-sample-vscode-flask-tutorial?branchName=main)](https://dev.azure.com/sandbox-david/DevopsLeanring/_build/latest?definitionId=13&branchName=main)
